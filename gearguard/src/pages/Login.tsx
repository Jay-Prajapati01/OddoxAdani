  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-sidebar relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_hsl(var(--primary)/0.3)_0%,_transparent_60%)]" />
        <div className="relative z-10 flex flex-col justify-between p-12">
          ...
          <div className="max-w-md">
            <h1 className="text-4xl font-bold text-sidebar-foreground mb-6">
              Welcome back to your maintenance command center
            </h1>
            <p className="text-lg text-sidebar-foreground/80">
              Track assets, manage teams, and keep your operations running smoothly.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-sidebar-foreground/70">
              Join 10,000+ maintenance professionals
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-background">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-2">Sign in to your account</h2>
